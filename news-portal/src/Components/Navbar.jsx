  ...
  return (
    <nav className="bg-blue-600 text-white p-4 shadow-lg">
      <div className="container mx-auto flex justify-between">
        <Link to="/" className="text-xl flex items-center font-bold"><img src={logo} className="h-10 w-auto object-contain mr-4 rounded-lg"></img><span className="font-sans font-bold">H&H</span></Link>
